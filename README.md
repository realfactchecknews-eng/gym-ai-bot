...
ведёт редактируемый план, считает воду/белок, напоминает о тренировках и
**оценивает форму по фото**. ИИ — через OpenRouter.
...
- `v1.0-stable` — полный функционал: планы, чек-ин, статистика, напоминания,
  трекеры воды/белка, оценка формы, чат с памятью; OpenRouter через воркер, Neon Postgres.

Откат к рабочей версии:
```bash
git checkout v1.0-stable
```
Скачать архивом: вкладка **Releases / Tags** в GitHub.
